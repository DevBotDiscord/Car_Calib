...
VISION_TEMPORAL_Y_WEIGHT = _get_float("VISION_TEMPORAL_Y_WEIGHT", 0.35)
VISION_CORRIDOR_ENABLED = _get_bool("VISION_CORRIDOR_ENABLED", True)
VISION_CORRIDOR_VERTICAL_MAX_ERROR_DEG = _get_float("VISION_CORRIDOR_VERTICAL_MAX_ERROR_DEG", 25.0)
VISION_CORRIDOR_MIN_GROUP_LENGTH_PX = _get_float("VISION_CORRIDOR_MIN_GROUP_LENGTH_PX", 80.0)
VISION_CORRIDOR_LATERAL_GAIN_DEG = _get_float("VISION_CORRIDOR_LATERAL_GAIN_DEG", 25.0)
VISION_CORRIDOR_MAX_THETA_OFFSET_DEG = _get_float("VISION_CORRIDOR_MAX_THETA_OFFSET_DEG", 25.0)
VISION_FILTER_ALPHA = _get_float("VISION_FILTER_ALPHA", 0.35)
