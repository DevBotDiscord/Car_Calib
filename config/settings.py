...
PROCESS_VIDEO_SHOW_PID_SIM = _get_bool("PROCESS_VIDEO_SHOW_PID_SIM", True)
PROCESS_VIDEO_SIM_SPEED_DEG_PER_SEC = _get_float("PROCESS_VIDEO_SIM_SPEED_DEG_PER_SEC", 120.0)
PROCESS_VIDEO_MAIN_FRAME_SCALE = _get_float("PROCESS_VIDEO_MAIN_FRAME_SCALE", 0.75)
PROCESS_VIDEO_SIM_PANEL_HEIGHT = _get_int("PROCESS_VIDEO_SIM_PANEL_HEIGHT", 240)
