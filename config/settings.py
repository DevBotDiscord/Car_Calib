...
VISION_VERTICAL_GROUP_MIN_ANGLE_DEG = _get_float("VISION_VERTICAL_GROUP_MIN_ANGLE_DEG", 65.0)
VISION_VERTICAL_GROUP_MAX_ANGLE_DEG = _get_float("VISION_VERTICAL_GROUP_MAX_ANGLE_DEG", 115.0)
VISION_LATERAL_MIN_TILE_WIDTH_PCT = _get_float("VISION_LATERAL_MIN_TILE_WIDTH_PCT", 0.10)
VISION_LATERAL_MAX_TILE_WIDTH_PCT = _get_float("VISION_LATERAL_MAX_TILE_WIDTH_PCT", 0.90)
